...
const Register = () => {
  ...
  return (
    <div className="w-full min-h-dvh max-h-dvh h-full p-4 flex gap-4 overflow-hidden relative bg-primary-inverted">
      <AuthRobot />
      <DarkMode className="border absolute top-5 right-5 h-fit p-2 md:p-3 rounded-full bg-tertiary-inverted [&_path]:!stroke-primary-inverted opacity-80 hover:opacity-100" />
      <div
