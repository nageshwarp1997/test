...
const Navbar = () => {
  ...
  return (
    <div className="h-16 lg:h-[100px] w-full flex justify-between items-center gap-3 sticky top-0 left-0 lg:-top-9 px-2 md:px-5 lg:px-10 bg-tertiary">
      <div className="h-12 md:min-h-16 md:h-full flex items-center justify-center">
        <img
      ...
      <div className="px-1 md:px-5 lg:hidden flex items-center gap-3">
        <UserMenuIcons />
